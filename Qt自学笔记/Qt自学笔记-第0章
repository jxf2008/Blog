...
## 关于Qt自学笔记
   我写这个系列的最大一个原因，就是当初我自学用的教材是<C++ Gui Qt4 编程>，这本书有些例子对于新手太难了，比如书上在第四章就介绍了一个制表程序，这个程序对于现在的我都需要花费大量的时间才能完成，如果对于新手那完全是一场灾难，事实上当初我自学的时候，看书就卡在这里，差点就放弃Qt了。所以我决定要写一个面向只有一些C++基础的新人，例子足够简单，却能学习到如何使用Qt编写一个漂亮且使用的PC程序.
